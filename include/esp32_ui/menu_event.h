...
namespace esp32_ui
{
  ...
  public:
    ...
    // If your main navigation encoder index is not 0,
    // use this to set it to something else
    void set_main_encoder_idx(int8_t idx)
    {
      MAIN_ENCODER_INDEX = idx;
    }
    int8_t main_encoder_idx() { return MAIN_ENCODER_INDEX; }
  };
